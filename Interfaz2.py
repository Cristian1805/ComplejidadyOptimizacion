...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(20, 60, 1200, 321))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
    
        
        # self.celda = QtGui.QTextTableCell
        
        self.QFileDialog = QtWidgets.QFileDialog()
        
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(20, 400, 71, 21))
        self.label.setObjectName("label")        
       
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(220, 400, 61, 21))
        ...
        self.lineEditPresupuesto.setGeometry(QtCore.QRect(480, 400, 121, 21))
        ...
        self.label_4.setGeometry(QtCore.QRect(220, 470, 61, 27))
        self.label_4.setObjectName("label_4")
        
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(410, 400, 81, 21))
        ...
        self.label_5.setGeometry(QtCore.QRect(290, 510, 411, 31))
    ...
    def cargarArchivo(self):       
        ...
        if (fname[0]!=""):
            ...
            for regionX in listaDeRegiones:
                ...
                item = QtWidgets.QTableWidgetItem(str(regionX.get_proporcion()))
                item.setTextAlignment(QtCore.Qt.AlignCenter)
                self.tableWidget.setItem(row, 6,  item)
                
                item = QtWidgets.QTableWidgetItem(str(regionX.get_EscalaValoracion()))
                item.setTextAlignment(QtCore.Qt.AlignCenter)
